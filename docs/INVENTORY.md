...
Complete index of every analysis in `analyses/`, organized by topic. **47 analyses total.**

## NQ analyses (27)

### NQ intraday candle retest series — 15m, n≈219-232 days
| # | Folder | Subject |
|---|---|---|
...
| 7 | [9am-1h-candle-hit-stats](../analyses/9am-1h-candle-hit-stats) | 9:00-10:00 1h |
| 8 | [6am-4h-candle-hit-stats](../analyses/6am-4h-candle-hit-stats) | 6:00-10:00 4h |

### NQ extended intraday stats (9 themes around 9:30)
| # | Folder | What it measures |
|---|---|---|
| 9 | [extended-stats/01-prior-day-hl-retest](../analyses/extended-stats/01-prior-day-hl-retest) | Does today retest yesterday's RTH H/L |
| 10 | [extended-stats/02-time-to-retest](../analyses/extended-stats/02-time-to-retest) | Distribution of when first retest happens |
| 11 | [extended-stats/03-max-excursion](../analyses/extended-stats/03-max-excursion) | How far past wick before pullback |
| 12 | [extended-stats/04-conditional-on-color](../analyses/extended-stats/04-conditional-on-color) | Green/red 9:30 → 74/21 directional asymmetry |
| 13 | [extended-stats/05-first-touch-direction](../analyses/extended-stats/05-first-touch-direction) | Which side hits first (coin flip without conditioning) |
| 14 | [extended-stats/06-midpoint-mean-reversion](../analyses/extended-stats/06-midpoint-mean-reversion) | Return to 9:30 midpoint |
| 15 | [extended-stats/07-hod-lod-timing](../analyses/extended-stats/07-hod-lod-timing) | When during day HOD/LOD set |
| 16 | [extended-stats/08-range-stats](../analyses/extended-stats/08-range-stats) | 9:30 range vs full day |
| 17 | [extended-stats/09-volume-profile](../analyses/extended-stats/09-volume-profile) | Volume by 15-min bucket through RTH |

### NQ 9:30 setup chain
| # | Folder | What it measures |
|---|---|---|
| 18 | [930-followthrough](../analyses/930-followthrough) | Color + correct retest → today's close direction (77% case) |
| 19 | [retest-conditional-stats](../analyses/retest-conditional-stats) | Retest rate × {wide-body, 200MA, regime change, VWAP confluence}. **VWAP confluence pushes 90% → 97%** |
| 20 | [setup-b-r-distribution](../analyses/setup-b-r-distribution) | Setup B with 1R stop. **-0.12 avg R, 44% stop-out** |

### NQ daily patterns (n≈6,700, 27 years)
| # | Folder | What it measures |
|---|---|---|
| 21 | [daily-patterns-v1](../analyses/daily-patterns-v1) | Streaks, NR7, close-quartile, gap fill, range-position |
| 22 | [daily-patterns-v2](../analyses/daily-patterns-v2) | Vol.1 stats × 200MA regime + combined signals |

### NQ weekly patterns (n≈1,398, 27 years)
| # | Folder | What it measures |
|---|---|---|
| 23 | [weekly-patterns-v1](../analyses/weekly-patterns-v1) | Weekly streaks, NR4, close-quartile, inside/outside, gap fill |
| 24 | [weekly-patterns-v2](../analyses/weekly-patterns-v2) | HOD/LOD by DOW, range vs 4-week, wick patterns, sequential closes |

### NQ pre-market
| # | Folder | What it measures |
|---|---|---|
| 25 | [pm-range-break-and-go](../analyses/pm-range-break-and-go) | RTH break of pre-market (4:00-9:30 ET) H/L |

### NQ session retests (3 killzones)
| # | Folder | Session |
|---|---|---|
| 26 | [london-candle-hit-stats](../analyses/london-candle-hit-stats) | London open killzone 3:00-4:15 ET |
| 27 | [asia-candle-hit-stats](../analyses/asia-candle-hit-stats) | Asia killzone 8:00-9:15 PM ET |

### NQ Globex re-open (preliminary, n=21)
| # | Folder | Session |
|---|---|---|
| 28 | [globex-6pm-candle-hit-stats](../analyses/globex-6pm-candle-hit-stats) | Globex 6:00-7:15 PM ET (small sample) |
